...
export function brandLogo(className: string, alt = "Runmesh · Agent Control Plane"): string {
  return `<img class="${className}" src="${BRAND_LOGO_ASSET}" alt="${escapeHtml(alt)}" width="1672" height="941" decoding="async">`;
}

export function meshMarkSvg(className = "mesh-mark"): string {
...
export function meshVisualGraphic(): string {
...
export function languageSwitch(): string { return `<div class="language-switch" data-no-i18n aria-label="Language"><a href="?lang=en" data-lang-toggle="en" hreflang="en">EN</a><a href="?lang=zh-CN" data-lang-toggle="zh-CN" hreflang="zh-CN">中文</a></div>`; }
