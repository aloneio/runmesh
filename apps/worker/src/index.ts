...
function copyValue(button){var value=button.getAttribute('data-copy');if(value!==null)return value;var panel=button.closest('[role=tabpanel]');var code=panel&&panel.querySelector('pre code');return code?(code.textContent||''):''}
