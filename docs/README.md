...
The latest published stable release is **0.1.3**, and this checkout describes the **0.1.4 candidate**. To use a new feature, deploy the compatible Worker, install the appropriate Runner package and refresh the client's tool catalog.
